...
<br>
主要有以下四种方法：<br><ul><li>(1)用来推断回应变量与预测变量之间关系的t检验法</li><li>（2）斜率m1的置信区间</li><li>（3）在给定一个特定的预测值条件下，回应变量<B>均值</B>的置信区间</li><li>（4）在给定一个特定的预测值条件下，回应变量<B>随机值</B>的预测区间</li></ul>
