...
![级联分类器示意图](/images/blog/cascade_classfier_tempt.jpg)
...
![窗口中心的方法示意图](/images/blog/feature_center_my_sample.jpg)
...
###  5.2  原理
 ...
 ![](/images/blog/face_detection_2.png)
...
![](/images/blog/face_detection_4.png)
...
$$
 arg _{R_k} \quad min_{b_k} \sum_{d^i}\sum_{x_k^i} \mid\mid \triangle x_*^{ki}-R_k\phi _k^i-b_k\mid \mid ^2
$$
